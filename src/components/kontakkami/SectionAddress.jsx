...
const SectionAddress = () => {
  ...
  return (
    ...
    >
      ...
      <p className='font-alexandria text-center md:text-left text-4xl md:text-6xl font-bold text-white '>Temukan <span className='text-[var(--color-sb-yellow)]'><br />Kami Di Sini</span></p>

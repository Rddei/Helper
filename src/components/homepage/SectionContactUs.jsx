    ...
    <div className='bg-[#0D0D0D] w-full h-auto py-30 px-[var(--padding-mobile)] md:px-[var(--padding-dekstop)]'>
        <div className='grid grid-cols-1 md:grid-cols-2 items-center h-full'>
            <div className='flex flex-col items-start justify-center gap-6 w-[80%]'>
                ...
                <p className='font-alexandria text-6xl font-bold text-white'>Solusi teknologi terdepan dari Sandbox.</p>
                <p className='text-[var(--color-sb-grey)] text-lg font-inter-tight'>Tingkatkan produktivitas dan efisiensi bisnis Anda sekarang, Jelaskan kebutuhan bisnis Anda kepada kami, dan kami akan membantu menemukan solusinya untuk Anda.</p>
            </div>
